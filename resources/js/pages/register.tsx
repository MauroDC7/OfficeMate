                    ...
                    {({ errors, processing }) => (
                        <div className="space-y-6">
                            ...
                            <fieldset>
                                ...
                                <div className="mt-2 space-y-2" role="radiogroup" aria-label="Rol">
                                    <label className={roleRowClassName}>
                                        ...
                                        />
                                        <span className="font-medium text-gray-800">Medewerker</span>
                                    </label>
                                    <label className={roleRowClassName}>
                                        <input
                                            type="radio"
                                            ...
                                            className={roleInputClassName}
                                        />
                                        <span className="font-medium text-gray-800">Beheerder</span>
                                    </label>
                                </div>
                                {errors.role ? (
