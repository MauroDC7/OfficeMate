...
import { destroy as destroyProject, show as showProject } from '@/routes/projects';
...
export function ProjectCard({ project, isAdmin, onEdit, onDeleted }: ProjectCardProps) {
    ...
    return (
        <article className="group relative flex flex-col rounded-xl border border-gray-200 bg-white shadow-sm transition hover:border-gray-300 hover:shadow-md">
            <Link
