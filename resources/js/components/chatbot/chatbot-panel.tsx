...
const headerIconButtonClass =
    'rounded-lg p-2 text-gray-500 transition hover:bg-white/80 hover:text-gray-800 disabled:cursor-not-allowed disabled:opacity-50';
...
export function ChatbotPanel({
    ...
    const showNewChatHint = !isLoading && messages.length > 1;
    const newChatDisabled = isLoading || isSending || isExecutingAction;
                ...
                <div className="shrink-0 border-b border-gray-100 bg-white px-4 py-2">
                    <p className="text-center text-xs text-gray-500">
                        ...
                        <button
                            ...
                            onClick={onNewChat}
                            disabled={newChatDisabled}
                            className="font-medium text-gray-800 underline decoration-gray-300 underline-offset-2 transition hover:text-gray-950 hover:decoration-gray-500 disabled:cursor-not-allowed disabled:opacity-50"
                        >
